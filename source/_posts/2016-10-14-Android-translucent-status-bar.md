...
但实际上并不总能一直</br>  
  ![trying stuff utill it work](https://api1.reindeer36.shop/static/imgs/Trying-stuff-Until-it-work.jpg)
...
看起来像这样
5.1图片展开:  
![5.1模拟器，图片展开](https://api1.reindeer36.shop/static/imgs/statusbar_5.0_expanded.png)  

5.1图片收起:  
  ![5.1模拟器，图片收起](https://api1.reindeer36.shop/static/imgs/statusbar_5.0_collapsed.png)  

4.4图片展开:  
  ![4.4模拟器，图片展开](https://api1.reindeer36.shop/static/imgs/statusbar_4.4_expanded.png)  

4.4图片收起:
  ![4.4模拟器，图片收起](https://api1.reindeer36.shop/static/imgs/statusbar_4.4_collapsed.png)  
