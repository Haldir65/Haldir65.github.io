...
但实际上并不总能一直</br>  
  ![trying stuff utill it work](http://www.haldir66.ga/static/imgs/Trying-stuff-Until-it-work.jpg)
...
4.4图片展开:  
  ![4.4模拟器，图片展开](http://www.haldir66.ga/static/imgs/statusbar_4.4_expanded.png)  

4.4图片收起:
  ![4.4模拟器，图片收起](http://www.haldir66.ga/static/imgs/statusbar_4.4_collapsed.png)  
