...
内部很多功能都交给了各个组件去完成
![](https://www.haldir66.ga/static/imgs/snapshot20161020135353.jpg)
ChildHelper 、AdapterHelper 、Recycler对于开发者来说并不常用，但它们在内部负责了许多针对Child View的管理。<!--more-->


- ViewHolder的创建
![](https://www.haldir66.ga/static/imgs/viewHolder_step_1.jpg)
...
![](https://www.haldir66.ga/static/imgs/viewHolder_step_2.jpg)
5. 最终LayoutManager将把这个View添加到UI，这时会调用RecyclerView的onViewAttachedToWindow回调（生命周期）。


- ViewHolder的回收(Reserves)
![](https://www.haldir66.ga/static/imgs/viewHolder_step_3.jpg)
...
![](https://www.haldir66.ga/static/imgs/snapshot20161020124442.jpg)
...
- ViewHolder的销毁
![](https://www.haldir66.ga/static/imgs/snapshot20161020124836.jpg)
...
![](https://www.haldir66.ga/static/imgs/snapshot20161020143554.jpg)
