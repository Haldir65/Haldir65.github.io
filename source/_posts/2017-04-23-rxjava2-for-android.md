...
![](https://api1.foster66.xyz/static/imgs/f21a6a245edfe0b19804be5b3df24a3d.jpg)
<!--more-->
...
```
![](https://api1.foster66.xyz/static/imgs/stream_compose.jpg)
...
以上三种数据源都有static方法生成：
例如
![from iterable](https://api1.foster66.xyz/static/imgs/creating_source_from_iterable.jpg)


![fromjust](https://api1.foster66.xyz/static/imgs/creating_source_from_just.jpg)
...
![](https://api1.foster66.xyz/static/imgs/4dab298b9f7ce29c43f9d8eaf686e02f.jpg)
```java
...
**this is wrong**
![Wrong](https://api1.foster66.xyz/static/imgs/reading_network_response_on_main_thread.jpg)

**this is right**
![Ok](https://api1.foster66.xyz/static/imgs/observing_on_ui_thread.jpg)
