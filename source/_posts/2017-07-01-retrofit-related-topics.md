...
![](https://api1.foster57.tk/static/imgs/d653491fb55bec754b8471aa6a3f6eed.jpg)
...
```      
ParameterHandler.Path<>在ParameterHandler这个类里面，看一下结构![](https://api1.foster57.tk/static/imgs/ParameterHandlers.jpg)
...
![endpoint](https://api1.foster57.tk/static/imgs/different_end_point.jpg)    

所以需要提取出一个OkHttpClient,解决方式很简单
![](https://api1.foster57.tk/static/imgs/different_end_point_the_right_way.jpg)
...
![](https://api1.foster57.tk/static/imgs/creating_two_converters.jpg)


#### 1.5.5 addConverterFactory可以调用多次
假如一个接口返回json，一个接口返回proto。不要试图创建多个retrofit实例。这样就可以了
![](https://api1.foster57.tk/static/imgs/different_response.jpg)
...
![](https://api1.foster57.tk/static/imgs/delegate_converters.jpg)
...
![](https://api1.foster57.tk/static/imgs/always_observe_on_mian_thread.jpg)
