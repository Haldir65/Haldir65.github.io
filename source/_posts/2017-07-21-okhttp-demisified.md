...
![](https://api1.foster57.tk/static/imgs/6da83b3b20094b044a320d1e89dfcd00.jpg)
<!--more-->
...
### 2.1 使用介绍
先上一张图![](https://api1.foster57.tk/static/imgs/okHttp_chain.jpg)。这是最简单的直接用OkHttpClient请求[百度首页](http://www.baidu.com)的堆栈调用情况。在没有做任何手动配置的情况下，至少发现了五个Interceptor:
