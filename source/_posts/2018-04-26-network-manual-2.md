...
![](https://api1.foster57.tk/static/imgs/jpglight-and-shadow-2411321_960_720.jpg)
<!--more-->
...
![](https://api1.foster57.tk/static/imgs/http_with_out_keep_alive.png)

http1.1中每个连接用完了不关闭,(保留一个keepAlive时间，在OkHttp里面默认一条连接在没有使用过的情况下保留5分钟才关闭)
![](https://api1.foster57.tk/static/imgs/http_with_keep_alive.png)
